            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-red-700">
                  {stockError && <div>• Error loading stock data: {typeof stockError === 'string' ? stockError : (stockError?.message || JSON.stringify(stockError, null, 2) || 'Unknown error')}</div>}
                  {budgetError && <div>• Error loading budgets: {typeof budgetError === 'string' ? budgetError : (budgetError?.message || JSON.stringify(budgetError, null, 2) || 'Unknown error')}</div>}
                </div>
              </div>
            </div>
          </div>
